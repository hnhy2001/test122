            ...
            <div className='flex flex-col gap-4'>
                <div className='flex justify-between'>
                    <div className='flex gap-4'>
                        <Image src={dt.company_logo} unoptimized alt='Logo' width={45} height={45} className='h-[45px] w-[45px] rounded-full object-cover' />
                        <div className='flex flex-col gap-1'>
                            <p className='text-sm font-bold text-[#081342] flex gap-1 items-center'>{dt.company_name} <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-blue-600">
                                ...
                                <div className='flex flex-col gap-1 min-h-full'>
                                    <div className='flex flex-col gap-3 overflow-auto h-full md:px-10 flex-1 py-4 md:py-0'>
                                        <div className='flex justify-between w-full'>
                                            <div className='flex gap-4'>
                                                <Image src={dt.company_logo} alt='Logo' width={45} height={45} className='h-[45px] w-[45px] rounded-full object-cover' />
                                                <div className='flex flex-col gap-1'>
                                                    <p className='text-sm font-bold text-[#081342] flex gap-1 items-center'>{dt.company_name} <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-blue-600">
                                                        <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12Zm13.36-1.814a.75.75 0 1 0-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 0 0-1.06 1.06l2.25 2.25a.75.75 0 0 0 1.14-.094l3.75-5.25Z" clipRule="evenodd" />
                                                    </svg></p>
                                    ...
                                    {
                                        user &&
                                        <div className='md:px-10 flex gap-4 items-start'>
                                            <Image src={user?.avatar} unoptimized alt={user.name} width={45} height={45} className='h-[45px] w-[45px] rounded-full object-cover' />
                                            <Textarea />
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
