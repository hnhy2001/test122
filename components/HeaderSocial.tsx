            ...
            <div className='container flex items-center justify-between py-4'>
                ...
                <div className='font-bold'>
                    <div className='flex gap-16 '>
                        ...
                        <Link href="/product" className={'font-bold text-[#081540]'}>
                            Products
                        </Link>
                        <Link href="/supplier" className={'font-bold text-[#081540]'}>
                            Suppliers
                        </Link>
                        <Link href="/buyer" className={'font-bold text-[#081540]'}>
                            Buyers
                        </Link>
                        <Link href="/rfq" className={'font-bold text-[#081540]'}>
                            RFQ
                        </Link>
                        <Link href="/pavilion" className={'font-bold text-[#081540]'}>
                            Pavilion
                        </Link>
                    </div>
                </div>
