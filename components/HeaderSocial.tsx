            ...
            <div className='container flex items-center justify-between py-4'>
                ...
                <div className='font-bold hidden md:block'>
                    <div className='flex'>
                        ...
                        <Link href="/product" className={'font-bold text-[#081540] w-28 text-center'}>
                            Products
                        </Link>
                        <Link href="/supplier" className={'font-bold text-[#081540] w-28 text-center'}>
                            Suppliers
                        </Link>
                        <Link href="/buyer" className={'font-bold text-[#081540] w-28 text-center'}>
                            Buyers
                        </Link>
