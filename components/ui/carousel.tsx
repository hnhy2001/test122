      ...
      >
        ...
        {length != 0 && (
          <div className="flex justify-center">
            <div className="flex gap-5 py-[3.625rem] mx-auto">
              {Array.from({ length: length }).map((value: any, idx: any) => (
                <div
                  className={`h-4 w-4 ${
                    idx == index ? "bg-[#081342]" : "bg-gray-400"
                  } rounded-full`}
                  key={idx}
                ></div>
              ))}
...
>(({ className, variant = "link", size = "icon", ...props }: any, ref) => {
